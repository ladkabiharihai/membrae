...
\author{Ashish~Kumar\thanks{A.~Kumar is an independent researcher. E-mail: ashish99anonymous@gmail.com. Preprint, July 2026. Code, checkpoints, and every measured number are released with this record.}}

\markboth{Kumar: Making a Diagonal-Complex Spin Recurrence the Load-Bearing Core of a Language Model}{Kumar: Making a Diagonal-Complex Spin Recurrence the Load-Bearing Core of a Language Model}
